function [Y1,U_tilde,U_tilde_SR] = TTN_integrator_complex_parallel_nonglobal(tau,Y0,F_tau,t0,t1,A,d,r_min)
...
for i=1:m
    ...
    if 0 == iscell(tau{i})    % if \tau_i = l, l \in L
        ...
        [Y1_i,U_tilde{i},U_tilde_SR{i}] = TTN_integrator_complex_parallel_nonglobal(tau{i},Y0_i,F_tau_i,t0,t1,A,d,r_min);
    end
